...
Friend Class frmToP
    ...
    Private Sub cboGEDSP_SelectedIndexChanged(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles cboGEDSP.SelectedIndexChanged
    ...
    Private Sub cmdFastForward_MouseDown(ByVal eventSender As Object, ByVal eventArgs As MouseEventArgs) Handles cmdFastForward.MouseDown
    ...
    Private Sub cmdFastForward_MouseUp(ByVal eventSender As Object, ByVal eventArgs As MouseEventArgs) Handles cmdFastForward.MouseUp
        Dim Button As Short = eventArgs.Button \ &H100000
        Dim Shift As Short = ModifierKeys \ &H10000
        Dim X As Single = VB6.PixelsToTwipsX(eventArgs.X)
        Dim Y As Single = VB6.PixelsToTwipsY(eventArgs.Y)
    ...
    Private Sub cmdPlay_Click(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles cmdPlay.Click
        Dim portstate As Byte
        Dim i As Short
        portstate = ReadSPC700(0)
        WriteSPC700(1, 0)
        ...
        grafic_change(8, _SldGraficEqualizer_8.Value)
        For i = 0 To 2
            If optOutput(i).Checked Then optOutput_CheckedChanged(optOutput.Item(i), New EventArgs())
        Next i
        sldPitch_Change(sldPitch, New EventArgs())
        sldTrans_Change(sldTrans, New EventArgs())
        sldPan_Change(sldPan, New EventArgs())
        If optReverb.Checked Then optReverb_CheckedChanged(optReverb, New EventArgs())
        If optDry.Checked Then optDry_CheckedChanged(optDry, New EventArgs())
        If optPanDelay.Checked Then optPanDelay_CheckedChanged(optPanDelay, New EventArgs())
    ...
    Private Sub optDry_CheckedChanged(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles optDry.CheckedChanged
        If (Not top_events_allowed) Then Exit Sub
    ...
    Private Sub optOutput_CheckedChanged(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles optOutput.CheckedChanged
        If (Not top_events_allowed) Then Exit Sub
        If eventSender.Checked Then
    ...
    Private Sub optPanDelay_CheckedChanged(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles optPanDelay.CheckedChanged
        If (Not top_events_allowed) Then Exit Sub
        If eventSender.Checked Then
            Dim portstate As Byte
            portstate = ReadSPC700(0)
    ...
    Private Sub optReverb_CheckedChanged(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles optReverb.CheckedChanged
        If (Not top_events_allowed) Then Exit Sub
        If eventSender.Checked Then
            Dim portstate As Byte
            portstate = ReadSPC700(0)
    ...
    Private Sub sldPan_Change(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles sldPan.Scroll
        Dim portstate As Byte
        portstate = ReadSPC700(0)
        WriteSPC700(1, &H3F)
        WriteSPC700(2, &HFF)
    ...
    Private Sub sldPitch_Change(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles sldPitch.Scroll
        Dim portstate As Byte
        portstate = ReadSPC700(0)
        WriteSPC700(1, &H3F)
        WriteSPC700(2, &HFF)
    ...
    Private Sub sldTrans_Change(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles sldTrans.Scroll
        Dim portstate As Byte
        portstate = ReadSPC700(0)
        WriteSPC700(1, &H3F)
        WriteSPC700(2, &HFF)
    ...
    Private Sub Stop_Renamed_Click(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles Stop_Renamed.Click
        Dim portstate As Byte
        portstate = ReadSPC700(0)
        WriteSPC700(1, &H4)
        WriteSPC700(2, &H10)
    ...
    Private Sub frmToP_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load

    End Sub

    Private Sub _SldGraficEqualizer_0_Change(ByVal sender As Object, ByVal e As EventArgs) Handles _SldGraficEqualizer_0.Scroll
        grafic_change(0, _SldGraficEqualizer_0.Value)
    End Sub

    Private Sub _SldGraficEqualizer_1_Change(ByVal sender As Object, ByVal e As EventArgs) Handles _SldGraficEqualizer_1.Scroll
        grafic_change(1, _SldGraficEqualizer_1.Value)
    End Sub

    Private Sub _SldGraficEqualizer_2_Change(ByVal sender As Object, ByVal e As EventArgs) Handles _SldGraficEqualizer_2.Scroll
        grafic_change(2, _SldGraficEqualizer_2.Value)
    End Sub

    Private Sub _SldGraficEqualizer_3_Change(ByVal sender As Object, ByVal e As EventArgs) Handles _SldGraficEqualizer_3.Scroll
        grafic_change(3, _SldGraficEqualizer_3.Value)
    End Sub

    Private Sub _SldGraficEqualizer_4_Change(ByVal sender As Object, ByVal e As EventArgs) Handles _SldGraficEqualizer_4.Scroll
        grafic_change(4, _SldGraficEqualizer_4.Value)
    End Sub

    Private Sub _SldGraficEqualizer_5_Change(ByVal sender As Object, ByVal e As EventArgs) Handles _SldGraficEqualizer_5.Scroll
        grafic_change(5, _SldGraficEqualizer_5.Value)
    End Sub

    Private Sub _SldGraficEqualizer_6_Change(ByVal sender As Object, ByVal e As EventArgs) Handles _SldGraficEqualizer_6.Scroll
        grafic_change(6, _SldGraficEqualizer_6.Value)
    End Sub

    Private Sub _SldGraficEqualizer_7_Change(ByVal sender As Object, ByVal e As EventArgs) Handles _SldGraficEqualizer_7.Scroll
        grafic_change(7, _SldGraficEqualizer_7.Value)
    End Sub

    Private Sub _SldGraficEqualizer_8_Change(ByVal sender As Object, ByVal e As EventArgs) Handles _SldGraficEqualizer_8.Scroll
        grafic_change(8, _SldGraficEqualizer_8.Value)
    End Sub
